// convert xy color values into hex and back, following the specs from
// https://developers.meethue.com/develop/application-design-guidance/color-conversion-formulas-rgb-to-xy-and-back/

module.exports = {
  xyToHex: function xyToHex(x, y, bri) {
    ...
    r = (Math.round(r * 254)).toString(16);
    g = (Math.round(g * 254)).toString(16);
    b = (Math.round(b * 254)).toString(16);
